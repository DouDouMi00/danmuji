<template>
    <v-card class="mx-auto" elevation="4" @keydown="onKeydown">
        ...
        <v-form class="overflow-auto">
            ...
            <v-switch v-model="config.filter.danmu.readfansMedalGuardLevel" inset color="blue" label="启用大航海头衔朗读" aria-label="启用大航海头衔朗读"></v-switch>
            <v-switch v-model="config.filter.danmu.readfansMedalName" inset color="blue" label="启用粉丝勋章等级播报" aria-label="启用粉丝勋章等级播报"></v-switch>
