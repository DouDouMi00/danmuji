...
async def initalizeKeyboard():
    ...
    if os.name == "nt":
        HotkeyConfig = getJsonConfig()['keyboard_hotkey']
        keyboard.add_hotkey(HotkeyConfig['handleFlush'], lambda: asyncio.run_coroutine_threadsafe(handleFlush(), runningLoop))
        keyboard.add_hotkey(HotkeyConfig['handleGetDelay'], lambda: asyncio.run_coroutine_threadsafe(handleGetDelay(), runningLoop))

        keyboard.add_hotkey(HotkeyConfig['handleTTSRatePlus'], lambda: asyncio.run_coroutine_threadsafe(handleTTSRatePlus(), runningLoop))
        keyboard.add_hotkey(HotkeyConfig['handleTTSRateMinus'], lambda: asyncio.run_coroutine_threadsafe(handleTTSRateMinus(), runningLoop))

        keyboard.add_hotkey(HotkeyConfig['handleTTSVolumePlus'], lambda: asyncio.run_coroutine_threadsafe(handleTTSVolumePlus(), runningLoop))
        keyboard.add_hotkey(HotkeyConfig['handleTTSVolumeMinus'], lambda: asyncio.run_coroutine_threadsafe(handleTTSVolumeMinus(), runningLoop))

        keyboard.add_hotkey(HotkeyConfig['handleTTSVoicePlus'], lambda: asyncio.run_coroutine_threadsafe(handleTTSVoicePlus(), runningLoop))

        keyboard.add_hotkey(HotkeyConfig['handleReadNextGiftMessages'], lambda: asyncio.run_coroutine_threadsafe(handleReadNextGiftMessages(), runningLoop))
        keyboard.add_hotkey(HotkeyConfig['handleReadNextHistoryDanmu'], lambda: asyncio.run_coroutine_threadsafe(handleReadNextHistoryDanmu(), runningLoop))
        keyboard.add_hotkey(HotkeyConfig['handleReadLastGiftMessages'], lambda: asyncio.run_coroutine_threadsafe(handleReadLastGiftMessages(), runningLoop))
        keyboard.add_hotkey(HotkeyConfig['handleReadLastHistoryDanmu'], lambda: asyncio.run_coroutine_threadsafe(handleReadLastHistoryDanmu(), runningLoop))
        keyboard.add_hotkey(HotkeyConfig['handleReadNewestMessages'], lambda: asyncio.run_coroutine_threadsafe(handleReadNewestMessages(), runningLoop))
