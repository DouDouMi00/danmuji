...
def messagesToText(msg):
    ...
    if msg['type'] == 'danmu':
        fansMedalGuardLeveltxt, fansMedalNametxt, fansMedalLeveltxt = "", "", ""
        if msg['fansMedalGuardLevel'] !=0 and filter_config["danmu"]["readfansMedalGuardLevel"]:
            fansMedalGuardLeveltxt = f"头衔{msg['fansMedalGuardLevel']}"
        ...
        return f"{fansMedalGuardLeveltxt} {fansMedalNametxt} {fansMedalLeveltxt} {msg['uname']}说{msg['msg']}"
    elif msg['type'] == 'gift':
